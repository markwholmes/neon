...
merge_df = (
    ...
    # .merge(church_non_umc_df[['Email Address','church_non_umc']].rename(columns={'Email Address':'Email'}), on='Email', how = 'left')
    .merge(combined_bad_email_df[['Email','bad_emails']], on='Email', how = 'left')

    # mailchimp_sub_df['mailchimp_sub'], left_on = 'Email', right_on = 'Email Address'
    )
